...
\begin{abstract}
Actualmente en la Facultad de Ciencias de la universidad de Burgos, existen muchos laboratorios que disponen de existencias de reactivos y productos químicos en sus instalaciones. Es importante que haya una correcta organización para así poder facilitar el compartir existencias entre laboratorios.
...
Así que para la actualización de la aplicación, se pasará de una aplicación de escritorio a una versión web que pueda facilitar el acceso a todos los usuarios del laboratorio y con un posible planteamiento de implementación responsive para poder utilizarla desde distintos dispositivos.
\end{abstract}
