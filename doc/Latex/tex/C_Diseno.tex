...
\imagen{diagrama-ER}{Diagrama entidad relación} 
...
\imagen{Login}{Diagrama de secuencia del login} 
...
\imagen{InsertarFicha}{Diagrama de secuencia de insertar ficha} 
...
\imagen{Diagrama-clases-small}{Diagrama de clases general} 

\imagen{Diagrama-conexion}{Diagrama de clases - Paquete geslab.database} 

\imagen{Diagrama-admin}{Diagrama de clases - Paquete geslab.admin} 

\imagen{Diagrama-user}{Diagrama de clases - Paquete geslab.user}

\imagen{Diagrama-servlets}{Diagrama de clases - Paquete geslab.servlets}
