 ...
 * Generated at: 2020-06-21 18:31:18 UTC
...
public final class registro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"row align-items-center justify-content-center py-6\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"col-6\">\r\n");
      out.write("\t\t\t\t\t<div class=\"row justify-content-center\">\r\n");
      out.write("\t\t\t\t\t<p class=\"col-12 login-info__texto text-center my-3 pl-0 \">¡Bienvenido a GesLab! <br><br>Estas ingresando con un usuario nuevo, por lo que para continuar deberás de introducir los siguientes datos.</p>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-12 login-form py-3 px-4\">\r\n");
      out.write("\t\t\t\t\t\t\t<form action=\"/registro.do\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row align-items-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"nombre-ip\" class=\"col-4 login-form__label\">Nombre</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"col-12 login-form__input\" name=\"nombre\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"nombre-ip\" placeholder=\"Mario Santamaria\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row align-items-center mt-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"correo-ip\" class=\"col-4 login-form__label\">Correo</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"col-12 login-form__input\" name=\"correo\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"correo-ip\" placeholder=\"msa@ubu.es\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row align-items-center mt-2\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn login-form__button py-0 px-3\">Entrar</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
