 ...
 * Generated at: 2020-05-22 16:34:34 UTC
...
for (Centro c : centros) {
      ...
      out.print(c.getCodcentro());
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"boton-tabla__accion boton-tabla__accion--success\"><i class=\"fas fa-times\"></i></button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"submit\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"btn-confirmar-centro-");
      out.print(c.getCodcentro());
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"boton-tabla__accion\"><i class=\"fas fa-check\"></i></button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
}
